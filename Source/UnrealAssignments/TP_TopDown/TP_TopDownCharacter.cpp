...
ATP_TopDownCharacter::ATP_TopDownCharacter()
{
	...
	TopDownTPPAttributes = LoadObject<UPawnAttributeAsset>(this, TEXT("/Script/Assignment_1_2.PawnAttributeAsset'/Game/Blueprints/TopDown_Properties.TopDown_Properties'"));
}
